...
(function ($, window) {
    ...
    Tour = (function () {
        ...
        Tour.prototype.start = function (force, beginStep) {
            var promise;
            if (force == null) {
                force = false;
            }
            ...
            if (this._current === null) {
                ...
                this._callOnPromiseDone(promise, this.showStep, beginStep || 0);
            }
            return this;
        };
        ...
        Tour.prototype.restart = function (beginStep) {
            this._removeState("current_step");
            this._removeState("end");
            return this.start(false, beginStep);
        };
        ...
        Tour.prototype._onResize = function (callback, timeout) {
            if (navigator.userAgent.match(/Windows Phone/i) == "Windows Phone") {
        ...
        Tour.prototype._showOverlayElement = function (element) {
            ...
            $("div.disable-pointer-event").remove();
            var tourStepBackground = $("div.tour-step-background");
            for (var i = 0; i < tourStepBackground.length; i++) {
                if (i != tourStepBackground.length - 1) {
                    $(tourStepBackground[i]).remove();
                }
            }
            $("div.tour-step-background").offset(offset);
            $('.popover[class*="tour-"]').css("z-index", "9999");
