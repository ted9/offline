...
define(['durandal/system', 'durandal/app', 'durandal/composition', 'durandal/activator', 'durandal/viewEngine', 'jquery', 'knockout'], function (system, app, composition, activator, viewEngine, $, ko) {
    ...
    MessageBox.defaultViewMarkup = [
        '<div data-view="plugins/messageBox" class="messageBox messagebox-fixed-width">',
            ...
            '<div class="modal-footer" data-bind="foreach: options">',
                '<button class="btn btn-default" data-bind="click: function () { $parent.selectOption($data); }, text: $data, css: { \'btn-danger\': $index() == 0, autofocus: $index() == 0 }"></button>',
            '</div>',
        '</div>'
    ].join('\n');
