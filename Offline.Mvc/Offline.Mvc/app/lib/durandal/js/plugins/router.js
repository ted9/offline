...
define(['durandal/system', 'durandal/app', 'durandal/activator', 'durandal/events', 'durandal/composition', 'plugins/history', 'knockout', 'jquery'], function(system, app, activator, events, composition, history, ko, $) {
    ...
    var createRouter = function() {
        ...
        router.loadUrl = function(fragment) {
            ...
            var originCoreFragment = coreFragment;
            coreFragment = coreFragment.toLowerCase();

            //Quoter report detail
            var reportDetailRoute = "quoter/quotereportdetail";
            if (coreFragment.indexOf(reportDetailRoute) > -1) {
                var paramPath = originCoreFragment.substring(reportDetailRoute.length);
                coreFragment = reportDetailRoute + paramPath;
            }
